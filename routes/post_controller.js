...
exports.search = function(req, res, next) {
    ...
    var name =  req.query.postName;
    var peticion ="%" + req.query.postName.split(' ').join('%') + "%";
    console.log(peticion);
    
    models.Post
        .findAll({where: ["title like ? OR body like ?", peticion, peticion], order: "updatedAt DESC"})
        .success(function(posts) {            
             res.render('posts/searchResult', {posts: posts});            
        })
